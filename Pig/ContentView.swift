...
//  Pig
//
//  Created by Keila Islas on 10/30/23.
//
                ...
                VStack {
                    ...
                    VStack(alignment: .leading) {
                        ...
                        Text("If the player rolls any other number, it is added to their turn total, and the player's turn continues.")
                            .padding()
                        Text("If the player chooses to \"hold\", their turn total is added to their game score, and it becomes the next player's turn.")
                            .padding()
